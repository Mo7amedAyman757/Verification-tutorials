...
// 4. Add the modports
    modport DUT (input Q_in, D_in, rstn, clk, output dispense, change);
    
    modport TEST (output Q_in, D_in, rstn, input clk, dispense, change);

    modport MONITOR (input Q_in, D_in, rstn, clk, dispense, change);
