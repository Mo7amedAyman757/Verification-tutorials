...
module ALSU_sva(ALSU_if ALSU_vif);
    ...
    property opcode_add_check;
        @(posedge ALSU_vif.clk) disable iff (ALSU_vif.rst)
        (ALSU_vif.opcode == ADD && FULL_ADDER == "ON" && !ALSU_vif.red_op_A && !ALSU_vif.red_op_B && !ALSU_vif.bypass_A && !ALSU_vif.bypass_B)
    ...
    property bypass_both_A_priority_check;
        @(posedge ALSU_vif.clk) disable iff (ALSU_vif.rst)
        (INPUT_PRIORITY == "A" && ALSU_vif.bypass_A && ALSU_vif.bypass_B)
        |=> ##1 (ALSU_vif.out == $past(ALSU_vif.A,2));
    endproperty        
    ...
    property red_op_or_both_check;
        @(posedge ALSU_vif.clk) disable iff (ALSU_vif.rst)
        (ALSU_vif.opcode == OR && INPUT_PRIORITY == "A" && ALSU_vif.red_op_A && ALSU_vif.red_op_B && !ALSU_vif.bypass_A && !ALSU_vif.bypass_B)
        |=> ##1 (ALSU_vif.out == |$past(ALSU_vif.A,2));
    endproperty        
    ...
    property red_op_xor_A_check;
        @(posedge ALSU_vif.clk) disable iff (ALSU_vif.rst)
        (ALSU_vif.opcode == XOR && INPUT_PRIORITY == "A" && ALSU_vif.red_op_A && !ALSU_vif.bypass_A && !ALSU_vif.bypass_B)
        |=> ##1 (ALSU_vif.out == ^$past(ALSU_vif.A,2));
    endproperty        
